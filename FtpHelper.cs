...
namespace manshin
{
    class FtpHelper
    {
        private static string FTPCONSTR = "ftp://ftp.darock.tk:55551";//FTP的服务器地址，格式为ftp://192.168.1.234:8021/
        private static string FTPUSERNAME = "manshin";//FTP服务器的用户名
        private static string FTPPASSWORD = "Darock114514";//FTP服务器的密码
        ...
        public static bool UploadFile(string path, string name)
        {
            ...
            path = path.Replace("\\", "/");
            path = FTPCONSTR + "/var/www/html/ms/userconf/" + name; //这个路径是要传到的ftp目录
